...
export function RequestCourseCtaBanner() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #040B11 0%, #071820 45%, #040e18 100%)' }}
      />
      ...
      <div className="relative px-8 py-8 lg:px-10 lg:py-9 pl-10">
        <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-10">
          ...
          >
            ...
            >
              Il catalogo è in continua espansione. Se hai bisogno di un argomento specifico
              o di un percorso su una tecnologia BIM non ancora presente, scrivici —
              valutiamo ogni richiesta per le prossime uscite.
            </p>

            {/* Topic chips — stagger entrance + hover glow */}
              ...
              {TOPICS.map((topic, i) => (
                <span
                  ...
                  className={cn(
                    ...
                    hoveredTopic === i && 'scale-105',
                  )}
                  style={{
                    color: ACCENT,
                    background: hoveredTopic === i ? `${ACCENT}20` : `${ACCENT}0e`,
                    borderColor: hoveredTopic === i ? `${ACCENT}60` : `${ACCENT}28`,
                    boxShadow: hoveredTopic === i ? `0 0 10px ${ACCENT}30` : 'none',
          ...
          <div className="shrink-0 flex flex-col items-start md:items-center gap-2">
            ...
            <p className="text-[0.68rem] text-text-muted">Ogni richiesta viene valutata</p>
          </div>
