...
export function RequestResourceCtaBanner() {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #040B11 0%, #0e0a1f 45%, #090614 100%)' }}
      />
      ...
      {/* Static violet glow — bottom left */}
      <div
      ...
      <div className="relative px-8 py-8 lg:px-10 lg:py-9 pl-10">
        <div className="flex flex-col md:flex-row md:items-center gap-8 md:gap-10">
          ...
          >
            ...
            >
              Non trovi la risorsa che ti serve?
            </h2>
            ...
            >
              Guide, template, script o ebook che vorresti trovare qui ma non ci sono ancora?
              Segnalacelo — le richieste più frequenti diventano le prossime risorse pubblicate.
            </p>

            {/* Resource type chips — stagger entrance + hover glow */}
          ...
          <div className="shrink-0 flex flex-col items-start md:items-center gap-2">
            <a
              href="mailto:risorse@aerabim.it"
