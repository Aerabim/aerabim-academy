    ...
    <Card topBorder="amber" className="text-center">
      <div className="px-6 py-8">
        ...
        <h3 className="font-heading text-[1rem] font-bold text-text-primary mb-1.5">
          Community riservata agli abbonati
        </h3>
        <p className="text-[0.82rem] text-text-secondary max-w-md mx-auto mb-5">
          Accedi alla community per confrontarti con altri professionisti BIM/AEC,
          condividere esperienze e ricevere supporto dal team AERABIM.
          Abbonati a Pro per entrare nella community.
        </p>
        <Link
          href="/catalogo-corsi"
